...
;Check if memory reference and add "B," for byte mode
	...
	JNZ	RET
	CMP	[byte OP1+1],RIX	;Referencing IX as a word?
	JZ	RET
	CMP	[byte OP1+1],RIY
	JZ	RET
BFLAG:
...
BLMOVE:	DB	0,'MOV',9,'SI,BX',0,'MOV',9,'DI,DX'
	DB	0,'REP',0,'MOVSB',0,'MOV',9,'DX,DI'
	DM	0,'MOV',9,'BX,SI'
CPIR:	DB	'CLD'
CMPREP:	DB	0,'MOV',9,'DI,BX',0,'REPNZ',0,'SCASB'
	DM	0,'MOV',9,'BX,DI'
DAD1:	DM	'LAHF',0,'ADD'
...
ODDPAR	RESB	1
EVEPAR	RESB	1
	RESB	5	;MINUS,PLUS,NOT ZERO,ZERO,NOT CARRY
CY	RESB	1
RAX	RESB	1
STP	RESB	1
RBX	RESB	1
